...
Check out sample code [here](https://github.com/JanssenProject/jans/blob/main/jans-config-api/server/src/main/java/io/jans/configapi/rest/ApiApplication.java#L31)
